...
public:
	...
	FWarriorCountDownAction(float InTotalCountDownTime, float InUpdateInterval, float& InRemainingTime, EWarriorCountDownActionOutput& InCountDownOutput, FLatentActionInfo& LatentActionInfo)
	:	bNeedToCancel(false),
		TotalCountDownTime(InTotalCountDownTime),
		UpdateInterval(InUpdateInterval),
		OutRemainingTime(InRemainingTime),
